      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-6 space-y-5 overflow-y-auto flex-1 text-xs">
            ...
            {/* Android App Package & Export Section */}
            <div className="space-y-2">
              <h3 className="font-semibold uppercase tracking-wider text-[11px] text-slate-400 flex items-center gap-1">
                <Smartphone className="w-3.5 h-3.5 text-emerald-400" />
                Android App & Play Store Bundle
              </h3>
              <div className="p-3 bg-emerald-950/20 border border-emerald-500/30 rounded-xl space-y-2.5">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <span className="font-semibold text-emerald-300 text-xs">com.aidocumenthelper.app</span>
                      <span className="text-[10px] px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 font-mono">v1.0.0</span>
                    </div>
                    <p className="text-[11px] text-slate-400 mt-0.5">
                      Includes pre-configured Google Play Billing v7, native bridge, release keystore, and Pro entitlement verification.
                    </p>
                  </div>
                </div>
                <div className="pt-1 flex items-center gap-2">
                  <a
                    href="/api/android/download-project"
                    download="ai-document-helper-android-project.zip"
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-semibold shadow-sm transition-colors"
                  >
                    <Download className="w-3.5 h-3.5" />
                    Export Android Project (.ZIP)
                  </a>
                </div>
                <div className="text-[10px] text-slate-400 bg-slate-900/60 p-2 rounded-lg border border-slate-800 space-y-1">
                  <p className="text-slate-300 font-medium">To compile the .AAB bundle locally or in CI/CD:</p>
                  <code className="block text-emerald-400 font-mono break-all text-[10px]">
                    ./gradlew :app:bundleRelease
                  </code>
                  <p className="text-slate-400">
                    Signing key alias: <span className="font-mono text-slate-300">aidocumenthelper</span> (pass: <span className="font-mono text-slate-300">AIDocHelper2026!</span>)
                  </p>
                </div>
              </div>
            </div>
